...
async function ensureAuthTables(): Promise<void> {
  ...
  try {
    ...
    "ALTER TABLE jobs ADD COLUMN IF NOT EXISTS materials text NOT NULL DEFAULT ''",
    "ALTER TABLE jobs ADD COLUMN IF NOT EXISTS budget text NOT NULL DEFAULT ''",
    "ALTER TABLE jobs ADD COLUMN IF NOT EXISTS risk text NOT NULL DEFAULT ''",
