...
const ul: React.CSSProperties = { margin: "0 0 12px 22px", padding: 0 };
  ...
  return (
    <div style={{ minHeight: "100vh", fontFamily: F, display: "flex", justifyContent: "center", padding: "48px 20px 80px" }}>
      <div style={{ width: "100%", maxWidth: 720 }}>
        ...
        <p style={p}>By creating an account or using Steward, you agree to the practices described in this Policy.</p>
